...
__bpf_kfunc int bl_hpack_decode(const u8 *src, u32 src__sz, char *dst, u32 dst__sz) {
    const u8 *end = src + src__sz;
    nghttp2_huff_decode t = {0, NGHTTP2_HUFF_ACCEPTED, 0};
    u8 c;
    int idx = 0;
