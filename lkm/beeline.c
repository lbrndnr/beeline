...
__bpf_kfunc int bl_base64url_encode(const u8 *src,
								  u32 src__sz,
								  char *dst,
								  u32 dst__sz)
{
...
__bpf_kfunc int bl_base64url_decode(const u8 *src,
								  u32 src__sz,
								  char *dst,
								  u32 dst__sz)
{
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("A module that adds coding functionality.");
MODULE_VERSION("1.0");
